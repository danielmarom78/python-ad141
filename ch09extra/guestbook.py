...
def find_user(user: Guest):
    ...
    for customer in get_customers:
        if customer[0] == user.firstname and customer[1] == user.middelname and customer[2] == user.lastname:
...
def index():
    ...
    # The requset is a POST and the session exists. We got more user data
