...
class Guest:
    def __init__(self, firstname, middleman, lastname,
                 address = '', city = '', state = '', country = '',
                 email = '', greeting = '', visits=0):
        self.firstname = str(firstname).strip().capitalize()
        self.middlename = str(middleman).strip().capitalize()
    ...
    def __str__(self):
        return "Guest[First: {}, Middle: {}, Last: {}, Address: {}, City: {}, State: {}, Country: {}, Email: {}, Greeting: {}, Visits: {}]".format(
